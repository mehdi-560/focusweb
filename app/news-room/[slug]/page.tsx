...
const articles = [
  {
    ...
    content: [
      ...
      "Representative Director Jamal Ahmed commented: 'Dubai has long been on our radar as a critical node in our global network. This partnership gives us a trusted, capable local presence that will allow us to serve our Middle East clients with the speed and reliability they expect from a Japanese trading company. We look forward to building a long-term relationship that creates lasting value for both sides.'",
